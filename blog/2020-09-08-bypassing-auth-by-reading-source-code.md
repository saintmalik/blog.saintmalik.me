...
image: /bgimg/bypassing-auth-source-cover.webp
tags: [websec, infosec]
---
...
<img src={`${useDocusaurusContext().siteConfig.url}/img/bypassauth.png`} alt="Bypass Auth"/>
...
<img src={`${useDocusaurusContext().siteConfig.url}/img/sourcecodeauth.webp`} alt="Source Code Auth"/>
...
<img src={`${useDocusaurusContext().siteConfig.url}/img/awesome.gif`} alt="Awesome"/>
