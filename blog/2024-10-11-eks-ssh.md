...
authors: Abdulmalik
image: https://saintmalikme.mo.cloudinary.net/bgimg/ssh-into-eks-node.webp
tags: [devops, eks]
---
...
its actually possible with the eks nodes too, but i think it doesn't just look straight forward like the normal instance but here is what i have done in the past, that did worked for me.

if you have deployed your EKS cluster in a declarative manner with terraform or opentofu, then this will be an easy feat.

All you need to do is attach the AmazonSSMManagedInstanceCore IAM Policy to the cluster as an additional policy, here what the syntax will look like in your IaC.
...
This will allow you exec into your eks worker node with ease and its even more secure than declaring those ssh public ansd private key thing, another security burden of how to keep your private keys safe, haha.
