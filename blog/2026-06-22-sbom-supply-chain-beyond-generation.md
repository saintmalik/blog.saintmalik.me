...
authors: Abdulmalik
image: /bgimg/sbom-beyond-generation-cover.webp
...
<picture>
  <source type="image/webp" srcset={`${useDocusaurusContext().siteConfig.url}/bgimg/sbom-beyond-generation.webp`} alt="SBOM supply chain beyond generation"/>
  <source type="image/png" srcset={`${useDocusaurusContext().siteConfig.url}/bgimg/sbom-beyond-generation.png`} alt="SBOM supply chain beyond generation"/>
  <img src={`${useDocusaurusContext().siteConfig.url}/bgimg/sbom-beyond-generation.png`} alt="SBOM supply chain beyond generation"/>
</picture>
