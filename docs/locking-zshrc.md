...
<picture>
  <source type="image/webp" srcSet={`${useDocusaurusContext().siteConfig.url}/bgimg/lockzshrc.webp`} />
  <source type="image/png" srcSet={`${useDocusaurusContext().siteConfig.url}/bgimg/lockzshrc.png`} />
  <img src={`${useDocusaurusContext().siteConfig.url}/bgimg/lockzshrc.png`} alt="Locking ZSH" />
</picture>
